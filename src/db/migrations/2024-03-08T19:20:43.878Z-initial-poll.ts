  ...
  await db.insertInto('Question')
    .values([
      ...
      },
      {
        localityId: localId,
        categoryId: economicId,
        question: 'Do you believe in increasing funding for public transportation to improve accessibility and reduce traffic congestion?',
      },
      {
        localityId: localId,
      ...
      },
      {
        localityId: localId,
        categoryId: technologyId,
        question: 'Should the city invest in smart technology to improve public services (e.g., waste management, water supply)?',
      },
      {
        localityId: localId,
      ...
      },
      {
        localityId: stateId,
        categoryId: healthId,
        question: 'Should the state expand Medicaid to provide more low-income individuals and families with health coverage?',
      },
      {
        localityId: stateId,
        categoryId: healthId,
      ...
      },
      {
        ...
        question: 'Do you believe in reforming the state\'s criminal justice system to focus more on rehabilitation than punishment?',
      },
      {
        localityId: stateId,
        categoryId: justiceId,
      ...
      },
      {
        localityId: federalId,
        categoryId: economicId,
        question: 'Should the federal government implement more stringent regulations on Wall Street and financial institutions?',
      },
      {
        localityId: federalId,
        categoryId: healthId,
      ...
      },
      {
        localityId: federalId,
        categoryId: environmentId,
        question: 'Do you support the United States rejoining international agreements focused on combating climate change?',
      },
      {
        localityId: federalId,
        categoryId: environmentId,
