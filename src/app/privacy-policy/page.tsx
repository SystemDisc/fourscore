...
export async function generateMetadata(): Promise<Metadata> {
  return generateCommonMetadata({
    ...
    description: 'Read the privacy policy to understand how FourScore handles your personal data.',
    url: 'https://fourscore.app/privacy-policy',
    openGraphType: 'website',
    keywords: ['privacy policy', 'FourScore', 'data protection'],
  });
}
  ...
  return (
    <main className='bg-white'>
      ...
      <section className='container mx-auto p-4'>
        ...
        <p className={className.p}>Last updated: August 5, 2024</p>
        ...
        <h2 className={className.h2}>Information Collection And Use</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Log Data</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Cookies</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Do Not Track Disclosure</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Service Providers</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Communications</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Business Transaction</h2>
        <p className={className.p}>
          If FourScore is involved in a merger, acquisition or asset sale, your Personal Information may be transferred.
          We will provide notice before your Personal Information is transferred and becomes subject to a different
          Privacy Policy.
        </p>
        <h2 className={className.h2}>Security</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Links To Other Sites</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Children&apos;s Privacy</h2>
        ...
        <h2 className={className.h2}>Changes To This Privacy Policy</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Google User Data</h2>
        <p className={className.p}>
        ...
        <h2 className={className.h2}>Contact Us</h2>
