    ...
    <>
      <div>
        ...
        <section className='pt-16 md:pl-8 pb-20 md:grid-cols-2 bg-white'>
          <div className='p-4'>
            <h2 className='text-5xl sm:text-6xl font-light tracking-wide mb-8'>
        ...
        <section className='from-[#9EA1A5] to-[#393C40] bg-gradient-to-b text-white pt-24 pb-36'>
          ...
          <div className='max-h-fit md:columns-3 md:col-span-2 gap-4 mx-4 md:mx-16 [&>*:not(:last-child)]:mb-4'>
            ...
            <Accordion
              isOpen
              header='As a voter, are my candidate selections, my answers, and my info kept private?'
              className='grid grid-cols-1 gap-4'
            ...
            <Accordion
              isOpen
              header='What party or political organization is FourScore affiliated with?'
              className='grid grid-cols-1 gap-4'
              wrapperClassname='break-inside-avoid-column break-after-column'
            >
              <p>None.</p>
            ...
            <Accordion
              isOpen
              header='How does FourScore make money?'
              className='grid grid-cols-1 gap-4'
              wrapperClassname='break-inside-avoid-column'
            >
              <p>
            ...
            <Accordion
              isOpen
              header='What does it cost to use FourScore?'
              className='grid grid-cols-1 gap-4'
              wrapperClassname='break-inside-avoid-column'
            >
        ...
        <section className='relative text-6xl text-white bg-white py-9'>
          <div className='flex md:w-[calc(100%_-_150px_*_5)] items-center justify-center md:justify-end bg-[#d3f2e0] h-24 px-4 mb-9'>
            Schools
          </div>
          <div className='flex md:w-[calc(100%_-_150px_*_4)] items-center justify-center md:justify-end bg-[#a7e6c1] h-24 px-4 mb-9'>
            Jobs
          </div>
          <div className='flex md:w-[calc(100%_-_150px_*_3)] items-center justify-center md:justify-end bg-[#7ad9a2] h-24 px-4 mb-9'>
            Taxes
          </div>
          <div className='flex md:w-[calc(100%_-_150px_*_2)] items-center justify-center md:justify-end bg-[#4ecd83] h-24 px-4 mb-9'>
            Crime
          </div>
          <div className='flex md:w-[calc(100%_-_150px_*_1)] items-center justify-center md:justify-end bg-[#22c064] h-24 px-4 mb-9 md:mb-0'>
            Traffic
          </div>
        ...
        <section className='min-h-screen from-[#9EA1A5] to-[#393C40] bg-gradient-to-b text-white md:flex items-center justify-center py-24 px-4 md:px-24 hidden'>
          <div className='grid grid-cols-2 text-4xl font-light'>
            ...
            <div className='flex items-center justify-center w-[242px] h-[273px] mx-auto -my-8 col-span-2'>
              <Image
                src='/images/home/circle-of-voter.svg'
                width={242}
                height={273}
                alt='Diagram'
              />
