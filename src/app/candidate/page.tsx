        ...
        >
          <div className='max-w-6xl mx-auto md:grid md:grid-cols-2 md:gap-8 px-4'>
            ...
            <div className='text-3xl font-light flex items-center justify-start content-center flex-wrap'>
              ...
              <p className='w-full mb-16'>You and the voter each take the same FourScore poll.</p>
              <p className='w-full mb-16'>
                When the voter completes their poll, they are shown all the candidates on their ballot and a FourScore
                rating next to each name. The FourScore rating ranges from 0% to 100% and is based on how similar your
                poll is with the voters&apos;.
              </p>
              <p className='w-full mb-16'>
                You promote your candidacy by connecting with supporters, non-supporters, and undecided voters on the
                issues that are most important to them.
              </p>
              <p className='w-full mb-16'>
                When it comes time to vote, voters pick their favorite candidates, and FourScore sends them a list of
                their selections. The voters take their list to the polls to reference when they cast their ballot.
              </p>
            </div>
            <div className='text-3xl font-light flex items-center justify-start content-center flex-wrap'>
              <h2 className='text-4xl mb-16 font-bold'>Meaningful Engagement</h2>
              <p className='w-full mb-16'>
                When you use FourScore to engage your community, you&apos;re doing so with the ability to send voters a
                specific message based on the issues they have identified as most important to them.
              </p>
              <p className='w-full mb-16 md:mb-0'>
                Here is an example of a FourScore email, sent to undecided voters who have identified crime as their top
                concern.
              </p>
            </div>
            <div className='flex items-center justify-center'>
            ...
            <div className='text-3xl font-light flex items-center justify-start col-span-2 md:max-w-2xl md:mx-auto md:text-center'>
              <p className='w-full mb-16'>
                When you engage voters about the issues they’re focused on, you will convert voters into supporters at a
                higher rate than the candidate who opts to make general statements while asking for money.
              </p>
            </div>
            <div className='text-3xl font-light flex items-center justify-start content-center flex-wrap'>
            ...
            <div className='max-h-fit md:columns-3 md:col-span-2 gap-4 mx-4 md:mx-16 [&>*:not(:last-child)]:mb-4'>
              ...
              >
                <p>
                  The FourScore rating helps voters find candidates who support the same issues they support. The more
                  you align when with a voter on the issues, the higher your FourScore rating.
                </p>
              </Accordion>
              <Accordion
                isOpen
              ...
              >
                <p>
                  When you sign up, you can create a candidate profile page. Your profile page highlights your
                  experience, education, volunteerism, and endorsements. When a voter is on the fence, this is where
                  they come to make their decision on who to support.
                </p>
              </Accordion>
              <Accordion
                isOpen
              ...
              >
                <p>
                  When voters fill out their local, state and national poll, it provides valuable insight on the area
                  you serve. This insight allows you to understand your community&apos;s needs and concerns better.
                  Additionally, you&apos;ll see which of your answers are most popular and least popular with your
                  community.
                </p>
              </Accordion>
              <Accordion
                ...
                wrapperClassname='break-inside-avoid-column break-after-column'
              >
                <p>Easily link your social accounts and campaign website to your FourScore candidate profile page.</p>
              </Accordion>
              <Accordion
                isOpen
              ...
              >
                <p>
                  You can quickly select your target audience based on their survey and send relevant messaging to that
                  audience.
                </p>
              </Accordion>
              <Accordion
            ...
            <div className='max-h-fit flex justify-center items-center flex-wrap md:col-span-2 gap-4 md:mx-16 [&>*:not(:last-child)]:mb-4'>
              <div className='max-w-3xl grid md:grid-cols-2 gap-4'>
                ...
                >
                  ...
                  <p>Set a budget and pay for only those emails that are opened</p>
                  <p>Email opens cost only 10¢</p>
                  <p>Emails sent to voters wanting to pledge cost only $1.25 per open</p>
                  <div className='text-center mt-8'>
