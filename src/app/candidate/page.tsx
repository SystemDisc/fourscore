          ...
          <div className="min-h-[calc(100vh_-_2.75rem_-_1rem)] lg:min-h-[calc(75vh_-_2.75rem_-_1rem)] flex items-center md:justify-start content-center flex-wrap md:pl-20 p-0 justify-center text-white">
            ...
            <div className="md:w-full text-2xl">
              ...
              <div className='max-w-xl w-full text-center mb-4'>
                <Button className='!tracking-wide rounded-tl-md rounded-br-md h-14 !px-8 [border-bottom-left-radius:1.75rem] [border-top-right-radius:1.75rem]' isLink href='/candidate'>
                  Get Started
                </Button>
              </div>
          ...
          <div className='max-w-6xl mx-auto lg:grid lg:grid-cols-2 lg:gap-8 px-4'>
            ...
            <div className='max-h-fit flex justify-center items-center flex-wrap lg:col-span-2 gap-4 lg:mx-16 [&>*:not(:last-child)]:mb-4'>
              <div className='max-w-3xl grid lg:grid-cols-2 gap-4'>
                ...
                <Accordion header='Engagement' className='grid grid-cols-1 gap-4' headerClassname='from-[#EEEEEE] to-[#D8D8D8] bg-gradient-to-bl text-center text-4xl' isOpen>
                  <p>
